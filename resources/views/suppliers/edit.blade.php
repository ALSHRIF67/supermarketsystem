...
<div class="max-w-2xl mx-auto animate-slide-up pb-12">
    ...
    <div class="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div class="space-y-1">
            <h2 class="text-3xl font-black text-slate-900 tracking-tight">تعديل المورد</h2>
            <p class="text-sm font-medium text-slate-500">تحديث بيانات الشركة الموردة <span class="text-emerald-600 font-bold">{{ $supplier->name }}</span> ومعلومات التواصل</p>
        </div>
        ...
        <form action="{{ route('suppliers.update', $supplier) }}" method="POST">
            ...
            <div class="p-8 md:p-12 space-y-10">
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        <input type="text" name="name" id="name" value="{{ old('name', $supplier->name) }}" 
                            ...
                            placeholder="مثال: مجموعة المراعي للمنتجات الغذائية" required>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="address" id="address" rows="3" 
                        ...
                        placeholder="العنوان الفعلي للشركة للتواصل وإرسال الطلبات المكتوبة...">{{ old('address', $supplier->address) }}</textarea>
                </div>
            </div>
            ...
            <div class="px-8 py-8 md:px-12 bg-slate-50/50 border-t border-slate-100 flex flex-col md:flex-row items-center justify-end gap-6">
                ...
                <button type="submit" class="btn-premium w-full md:w-auto order-1 md:order-2 px-10 py-4 flex items-center justify-center gap-3">
                    ...
                    <span class="font-black text-lg">تحديث بيانات المورد</span>
                </button>
            </div>
        </form>
    </div>
