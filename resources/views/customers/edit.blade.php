...
<div class="max-w-2xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <h2 class="text-xl font-semibold text-slate-800">Edit Customer</h2>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="address" id="address" rows="3" 
                        class="w-full rounded-lg border-slate-200 focus:border-indigo-500 focus:ring-indigo-500"
                        placeholder="Customer's physical address...">{{ old('address', $customer->address) }}</textarea>
                </div>
                ...
                <div class="pt-4 flex items-center gap-4">
                    ...
                    <a href="{{ route('customers.index') }}" class="flex-1 bg-slate-100 hover:bg-slate-200 text-slate-700 text-center font-bold py-3 px-4 rounded-lg transition-colors">
                        Cancel
                    </a>
                </div>
            </div>
