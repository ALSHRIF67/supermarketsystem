...
<div class="max-w-2xl mx-auto animate-slide-up pb-12">
    ...
    <div class="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div class="space-y-1">
            <h2 class="text-3xl font-black text-slate-900 tracking-tight">تسجيل مصروف جديد</h2>
            <p class="text-sm font-medium text-slate-500">توثيق المصروفات الإدارية والتشغيلية بدقة لضبط الميزانية</p>
        </div>
    ...
    <div class="premium-card overflow-hidden">
        <form action="{{ route('expenses.store') }}" method="POST">
            ...
            <div class="px-8 py-8 md:px-12 bg-slate-50/50 border-t border-slate-100 flex flex-col md:flex-row items-center justify-end gap-6">
                ...
                <button type="submit" class="btn-premium w-full md:w-auto order-1 md:order-2 px-10 py-4 flex items-center justify-center gap-3 bg-rose-600 hover:bg-rose-700 shadow-rose-500/20">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0-2.08.402-2.599-1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    <span class="font-black text-lg">حفظ المصروف</span>
                </button>
            </div>
        </form>
    </div>
