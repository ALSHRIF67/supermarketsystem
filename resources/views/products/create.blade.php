...
<div class="max-w-4xl mx-auto animate-fade-in">
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-slate-800">إضافة منتج جديد</h2>
            <p class="text-slate-500 mt-1">أدخل تفاصيل المنتج ومعلومات المخزون بدقة</p>
        </div>
            ...
            <div class="p-6 md:p-10 space-y-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="md:col-span-1">
                        ...
                        <p class="text-sm text-slate-500 mt-1">البيانات التعريفية للمنتج التي تظهر في الفواتير والبحث.</p>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="md:col-span-1">
                        ...
                        <p class="text-sm text-slate-500 mt-1">تحديد التكاليف، أسعار البيع، والكميات المتوفرة.</p>
                    </div>
