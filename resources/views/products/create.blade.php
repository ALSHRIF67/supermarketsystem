...
<div class="max-w-4xl mx-auto animate-slide-up pb-12">
    ...
    <div class="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div class="space-y-1">
            <h2 class="text-3xl font-black text-slate-900 tracking-tight">إضافة منتج جديد</h2>
            <p class="text-sm font-medium text-slate-500">أدخل تفاصيل المنتج ومعلومات المخزون بدقة لضمان دقة العمليات</p>
        </div>
        ...
        <form action="{{ route('products.store') }}" method="POST">
            ...
            <div class="p-8 md:p-12 space-y-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                    <div class="md:col-span-1 space-y-2">
                        ...
                        <p class="text-xs font-medium text-slate-400 leading-relaxed">البيانات التعريفية للمنتج التي تظهر في الفواتير والبحث والتقارير.</p>
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" 
                                ...
                                placeholder="مثال: حليب المراعي 1 لتر" required autofocus>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                    <div class="md:col-span-1 space-y-2">
                        ...
                        <p class="text-xs font-medium text-slate-400 leading-relaxed">تحديد التكاليف، أسعار البيع، والكميات المتوفرة لضبط الأرباح.</p>
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                <label for="stock_quantity" class="text-[10px] font-black uppercase tracking-widest text-slate-400 pr-2">الكمية الافتتاحية</label>
            ...
            <div class="px-8 py-8 md:px-12 bg-slate-50/50 border-t border-slate-100 flex flex-col md:flex-row items-center justify-end gap-6">
                ...
                <button type="submit" class="btn-premium w-full md:w-auto order-1 md:order-2 px-10 py-4 flex items-center justify-center gap-3">
                    ...
                    <span class="font-black text-lg">حفظ بيانات المنتج</span>
                </button>
            </div>
        </form>
    </div>
