...
<div class="max-w-2xl mx-auto animate-slide-up pb-12">
    ...
    <div class="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div class="space-y-1">
            <h2 class="text-3xl font-black text-slate-900 tracking-tight">إضافة عميل جديد</h2>
            <p class="text-sm font-medium text-slate-500">تسجيل بيانات العميل بدقة لتعزيز التواصل وبرامج الولاء</p>
        </div>
        ...
        <form action="{{ route('customers.store') }}" method="POST">
            ...
            <div class="p-8 md:p-12 space-y-10">
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        <input type="text" name="name" id="name" value="{{ old('name') }}" 
                            ...
                            placeholder="مثال: أحمد علي حسن" required autofocus>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="address" id="address" rows="3" 
                        ...
                        placeholder="عنوان السكن أو العمل المعتمد لإيصال الطلبات...">{{ old('address') }}</textarea>
                </div>
            </div>
            ...
            <div class="px-8 py-8 md:px-12 bg-slate-50/50 border-t border-slate-100 flex flex-col md:flex-row items-center justify-end gap-6">
                ...
                <button type="submit" class="btn-premium w-full md:w-auto order-1 md:order-2 px-10 py-4 flex items-center justify-center gap-3">
                    ...
                    <span class="font-black text-lg">تسجيل بيانات العميل</span>
                </button>
            </div>
        </form>
    </div>
